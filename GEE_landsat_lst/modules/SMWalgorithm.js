...
var LSTfun = require('users/yyyh48201/GEE_landsat_lst:modules/SMWalgorithm.js')
...
INPUTS:
        ...
        - image: <ee.Image>
                image for which to calculate the LST
OUTPUTS:
        - <ee.Image>
...
var SMWcoef = require('users/yyyh48201/GEE_landsat_lst:modules/SMW_coefficients.js');
